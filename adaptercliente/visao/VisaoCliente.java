...
public class VisaoCliente extends javax.swing.JFrame {
    ...
    public void setInformacoesCliente(Cliente clienteExterno){
               
        String texto = "Nome:" +  clienteExterno.getNomeCompleto() + " \n";        
        texto += "Email:" +  clienteExterno.getEmail()+ " \n";  
        texto += "Telefone:" +  clienteExterno.getTelefone()+ " \n";  
        texto += "Celular:" +  clienteExterno.getCelular()+ " \n";       
