...
public class TelaPagamentos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       cartao.processHander(lista, Integer.parseInt(valorFatura.getText())); 
       cheque.setNextHandler(dinheiro);
       if(caixaSelecaoCheque.isSelected())
          lista.add(ChequeHandler.CHEQUE);
       cheque.processHander(lista, Integer.parseInt(valorFatura.getText()));
       if(caixaSelecaoDinheiro.isSelected())
          lista.add(DinheiroHandler.DINHEIRO); 
       dinheiro.processHander(lista, Integer.parseInt(valorFatura.getText()));                 
